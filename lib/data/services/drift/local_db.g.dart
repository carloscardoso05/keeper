...
class $UserTableTable extends UserTable
  ...
  UserTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return UserTableData(
      ...
      type: $UserTableTable.$convertertype.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
...
class UserTableData extends DataClass implements Insertable<UserTableData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['name'] = Variable<String>(name);
    {
      map['type'] = Variable<String>(
        $UserTableTable.$convertertype.toSql(type),
      );
    }
    return map;
  }
  ...
  factory UserTableData.fromJson(
    ...
    return UserTableData(
      ...
      type: $UserTableTable.$convertertype.fromJson(
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'type': serializer.toJson<String>(
        $UserTableTable.$convertertype.toJson(type),
      ),
    };
  }
...
class UserTableCompanion extends UpdateCompanion<UserTableData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (type.present) {
      map['type'] = Variable<String>(
        $UserTableTable.$convertertype.toSql(type.value),
      );
    }
    return map;
  }
...
class $ItemTableTable extends ItemTable
  ...
  static const VerificationMeta _holderIdMeta = const VerificationMeta(
    'holderId',
  );
  @override
  ...
  ItemTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ItemTableData(
      ...
      holderId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}holder_id'],
      ),
    );
  }
...
final class $$UserTableTableReferences
  ...
  _itemTableRefsTable(_$LocalDb db) => MultiTypedResultKey.fromTable(
    db.itemTable,
    aliasName: $_aliasNameGenerator(db.userTable.id, db.itemTable.holderId),
  );
  ...
  _projectTableRefsTable(_$LocalDb db) => MultiTypedResultKey.fromTable(
    db.projectTable,
    aliasName: $_aliasNameGenerator(
      db.userTable.id,
      db.projectTable.responsibleId,
    ),
  );
    ...
    : super(
        TableManagerState(
          ...
          updateCompanionCallback:
              ...
              }) => UserTableCompanion(id: id, name: name, type: type),
          createCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                required String name,
                required UserType type,
              }) => UserTableCompanion.insert(id: id, name: name, type: type),
          withReferenceMapper:
              (p0) =>
                  p0
                      .map(
